      ...
      <div className="min-h-screen flex items-center justify-center p-6 bg-gradient-to-br from-emerald-50 to-teal-50">
        <div className="max-w-md w-full text-center space-y-6">
          ...
          <div>
            ...
            <p className="text-emerald-600 mt-2">Your shop <strong>{application.shop_name}</strong> is now active on RepairXpert!</p>
          </div>
        ...
        <div className="max-w-xl mx-auto">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-white/70 text-sm">Register your repair shop on RepairXpert</p>
            </div>
          </div>
        </div>
      </div>
          ...
          {step === 3 && (
            <div className="space-y-4 animate-in fade-in slide-in-from-right-4">
              ...
              <div className="p-3 rounded-xl bg-amber-50 border border-amber-200 text-xs text-amber-700">
                ⚠️ Your application will be reviewed by the RepairXpert admin team. Approval usually takes 12–24 hours.
              </div>
